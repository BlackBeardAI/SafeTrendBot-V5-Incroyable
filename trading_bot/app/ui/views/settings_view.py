...
class SettingsView(QWidget):
    ...
    def _load_from_config(self):
        ...
        self.risk_percent.setValue(s.risk_percent)
        self.risk_reward.setValue(s.risk_reward_ratio)
        self.atr_period.setValue(s.atr_period)
        self.atr_multiplier.setValue(s.atr_multiplier)
        self.max_consec_losses.setValue(s.max_consecutive_losses)
        self.max_daily_loss.setValue(s.max_daily_loss_percent)
        self.fast_ema.setValue(s.fast_ema)
        self.slow_ema.setValue(s.slow_ema)
        self.rsi_period.setValue(s.rsi_period)
        self.rsi_overbought.setValue(s.rsi_overbought)
        self.rsi_oversold.setValue(s.rsi_oversold)
        self.start_hour.setValue(s.start_hour)
        self.end_hour.setValue(s.end_hour)
        self.trade_friday.setChecked(s.trade_on_friday)
        self.min_bars.setValue(s.min_bars_between_trades)
        self.magic_number.setValue(s.magic_number)
