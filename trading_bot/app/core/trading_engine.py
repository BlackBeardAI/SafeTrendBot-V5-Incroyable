"""
SafeTrendBot Trading Engine — Moteur de trading unifié (LEGACY)
================================================================
⚠️  DÉPRÉCIATION : ce module conserve l'ancien moteur V1 (TradingEngineLegacy)
    pour compatibilité ascendante. Les TYPES partagés (MarketRegime,
    TradeDirection, BrokerType, Signal, Position, TradeResult, RegimeDetector)
    ont été déplacés vers `app.core.bot_types` — importez-les depuis là.

    Pour le moteur courant, utilisez `app.core.trading_engine_v4`
    (TradingEngineV4).
...
# ═══════════════════════════════════════════════════════════════════════════════
# TYPES PARTAGÉS — réexportés depuis app.core.bot_types (source de vérité)
# ═══════════════════════════════════════════════════════════════════════════════
from app.core.bot_types import (
    MarketRegime, TradeDirection, BrokerType, Signal, Position,
    TradeResult, RegimeDetector,
)
...
class TradingEngineLegacy:
    """
    Moteur de trading principal (V1 — LÉGACY).
...
# ═══════════════════════════════════════════════════════════════════════════════
# ALIAS DE COMPATIBILITÉ — TradingEngine pointe vers le moteur legacy V1.
# Pour le moteur courant, importer TradingEngineV4 depuis trading_engine_v4.
# ═══════════════════════════════════════════════════════════════════════════════
TradingEngine = TradingEngineLegacy
